...
function optionChanged(selectedID){
    ...
    // Metadata loaded for the selected ID
 ...
 const guageData = [
    {
      ...
      mode: "gauge+number",     
       ...
       bar: { color: "#f2e9e4" },
       steps: [
          { range: [0, 1], color: "#eef7f0" },
          { range: [1, 2], color: "#ddeee1" },
          { range: [2, 3], color: "#cbe6d2" },
          { range: [3, 4], color: "#badec3" },
          { range: [4, 5], color: "#a9d6b4" },
          { range: [5, 6], color: "#98cda5" },
          { range: [6, 7], color: "#87c596" },
          { range: [7, 8], color: "#75bd87" },
          { range: [8, 9], color: "#64b478" }
